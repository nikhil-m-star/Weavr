      ...
      <div className="bg-[#050505] text-white min-h-screen flex flex-col font-sans overflow-x-hidden selection:bg-accent-cyan selection:text-black">
        ...
        <header className="fixed top-0 left-0 right-0 py-6 px-8 flex items-center justify-between z-50 mix-blend-difference">
          <div className="flex items-center space-x-2.5">
            <span className="text-xl font-black uppercase tracking-[0.2em]">Weavr</span>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 relative">
          ...
          <div className="text-center max-w-5xl z-10 space-y-8 select-none">
            ...
            <div className="pt-8">
              <SignInButton mode="modal">
                <button className="border border-white/10 hover:border-accent-cyan hover:text-accent-cyan bg-white/5 rounded-full px-8 py-3.5 text-xs font-bold uppercase tracking-[0.2em] text-white shadow-2xl transition duration-300 cursor-pointer">
                  Initiate Alignment
                </button>
              </SignInButton>
            </div>
